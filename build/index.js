...
(() => {
  ...
  var UserForm = class extends View {
    ...
    eventsMap() {
      return {
        ...
        //pas de () car on stock la methode et on ne l'invoque pas
  ...
  var user = User.buildUser({ name: "John Doe", age: 45 });
  var userEdit = new UserEdit(parent, user);
  userEdit.render();
